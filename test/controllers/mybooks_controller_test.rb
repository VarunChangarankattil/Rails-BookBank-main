...
class MybooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mybook" do
    assert_difference('Mybook.count') do
      post mybooks_url, params: { mybook: { price: @mybook.price, title: @mybook.title, year: @mybook.year } }
    end
  ...
  test "should update mybook" do
    patch mybook_url(@mybook), params: { mybook: { price: @mybook.price, title: @mybook.title, year: @mybook.year } }
